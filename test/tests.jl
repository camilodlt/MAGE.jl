...
include("programs/sample_programs.jl")
include("programs/test_decode_program.jl")
include("programs/test_compile_program.jl")
include("programs/test_population_sequential_program.jl")
include("adf/test_adf.jl")
...
include("libraries/number/test_haar_from_img.jl")
include("libraries/float/test_orientation_summary.jl")
include("libraries/image3D/test_color_statistics_rgb.jl")
include("libraries/image3D/test_spatial_rgb.jl")
include("libraries/image3D/test_composition_rgb.jl")
include("libraries/image2D/test_saliency_fixation_image2D.jl")
include("libraries/image2D/test_foreground_extraction_discrete_image2D.jl")
include("libraries/image2D/test_foreground_extraction_continuous_image2D.jl")

include("libraries/image2D/test_blob_extraction_image2D.jl")
...
include("libraries/test_llm_generated_functions.jl")
...
include("libraries/test_manual_dispatcher.jl")
...
include("libraries/image2D/test_orientation_image2D.jl")

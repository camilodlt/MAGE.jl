...
struct MapelitesRepertoire <: Abstract_MapElitesRepertoire
    ...
    function MapelitesRepertoire(centroids::Vector{Vector{Float64}})
        ...
        return new(pop, fitness_values, descriptors, centroids)
    end
end

function StatsBase.sample(rep::MapelitesRepertoire, n_samples::Int)
...
function batch_insert!(
    ...
    descriptors::Vector{Vector{Float64}},
)
